...
public class Player : MonoBehaviour
{
    ...
    private float playAreaMaxX = 3f; //can be change due to power up
    ...
    private void Update()
    {
        if (gameObject.CompareTag("Player")) //additional space craft cannot be moved
        {
            MovePlayer();
        }
        Shoot();
